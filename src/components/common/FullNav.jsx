...
const FullNav = () => {
  ...
  return (
    <div className="fullnav min-h-screen w-full bg-black">
      <div className="flex justify-between">
        ...
        <div className="w-[8.8vw] h-[9vw] ml-[2vw]">
          <button className="cursor-pointer">
            <RiCloseLargeLine className="text-[9vw]" />
          </button>
        </div>
      </div>
      <div className="mt-[5vw] flex flex-col">
        <div
          ...
          className="links cursor-pointer relative h-full w-full bg-black text-zinc-500"
        >
          <h1 className="font-extrabold font-[font2] text-[7vw] text-center border-y">TRACK-RECORDS</h1>

          <div
            ref={(el) => (navRef.current[0] = el)}
            className="moveX flex absolute bg-blue-950 text-white h-0 top-0 w-full overflow-x-auto items-center transition-all duration-300 ease-[cubic-bezier(0.76,0,0.24,1)] [&::-webkit-scrollbar]:hidden  "
          >
            <div className="moveX flex items-center w-max h-full">
              <h2 className="whitespace-nowrap font-extrabold font-[font2] text-[7vw]">PURE DOMINANCE</h2>
        ...
        >
          ...
          <div
            ...
            className="moveX flex absolute bg-red-950 text-white h-0 top-0 w-full overflow-x-auto items-center transition-all duration-300 ease-[cubic-bezier(0.76,0,0.24,1)] [&::-webkit-scrollbar]:hidden "
          >
            <div className="moveX flex items-center w-max h-full">
        ...
        >
          ...
          <div
            ...
            className="moveX flex absolute bg-slate-900 text-white h-0 top-0 w-full overflow-x-auto items-center transition-all duration-300 ease-[cubic-bezier(0.76,0,0.24,1)] [&::-webkit-scrollbar]:hidden "
          >
            <div className="moveX flex items-center w-max h-full">
